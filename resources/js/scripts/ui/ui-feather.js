...
$(function () {
    ...
    icons.map(function (icon) {
      if (iconsContainer.length) {
        iconsContainer.append(
          '<div class="card icon-card cursor-pointer fathericons text-center mb-2 mx-50" data-bs-html="true" data-bs-toggle="tooltip" data-bs-placement="top" title="' +
            icon +
  ...
  function copyToClipboard(value) {
    ...
    tempInput.select();
    toastr['success'](tempInput.value.split("'")[1], 'Refência copiada.', {
      closeButton: true,
      tapToDismiss: false,
      rtl: isRtl
    });
  ...
  // Copy Icon On Click
  $(document).on('click', '.fathericons', function () {
    var $this = $(this),
