...
@section('title', 'Gestão das Habilidades das Classes')
@section('styles')
<style>
    .card-scroll {
        overflow-y: auto;
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row">
                    <h5 class="card-title mb-sm-0 me-2">Gestão de Habilidades das Classes de Usuários</h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 mx-auto p-4">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="cadastro" aria-labelledby="cadastro-tab" role="tabpanel">
                                    @livewire($canConsult ? 'l-w-classes-habilidades' : 'aviso-tipo1')
                                </div>
    ...
    if (select2.length) {
        select2.each(function () {
            ...
            $this.wrap('<div class="position-relative"></div>').select2({
                ...
                if (this.id === 'classe_id_select') {
                    Livewire.emit('updatedClasseId', this.value);
                }
