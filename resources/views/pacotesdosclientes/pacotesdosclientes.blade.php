...
@section('title', 'Gestão dos Pacotes dos Clientes')
@section('styles')
<style>
    .card-scroll {
        overflow-y: auto;
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row">
                    <h5 class="card-title mb-sm-0 me-2">Gestão dos Pacotes dos Clientes</h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 mx-auto p-4">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="cadastro" aria-labelledby="cadastro-tab" role="tabpanel">
                                    @livewire($canConsult ? 'l-w-pacotes-clientes' : 'aviso-tipo1')                                        
                                </div>
