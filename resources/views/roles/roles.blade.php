...
@section('title', 'Gerencia de Papeis no Sistema')
@section('styles')
    <style>
    input[type=color] {
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row">
                    <h5 class="card-title mb-sm-0 me-2">Gestão Classes de Usuários</h5>
                    <div class="action-btns">
                        ...
                        <button class="btn btn-primary" type="button" title="Novo Classe de usuário" onclick="Livewire.emit('novoRole')"><i class='fa fa-add'></i></button>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 mx-auto p-4">
                            @livewire($canConsult ? 'role-table2' : 'aviso-tipo1')
                        </div>
                    </div>
                </div>
            </div>
