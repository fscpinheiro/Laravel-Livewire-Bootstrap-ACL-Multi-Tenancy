...
class LWAdmUsuario extends Component
{
    use WithFileUploads;
    ...
    protected $listeners = [
        'novoUser' => 'novoUser', 
        'ADMeditUser'=>'editar',
        'ADMdeleteUser'=>'deletar', 
        'updatedRoleId'=>'updatedRoleId', 
        'updatedSituacao'=> 'updatedSituacao'
    ];

    public $aplicativo_id;
    public $clientes, $roles, $situacoes, $user_id, $cliente_id, $role_id, $nome, $email, $senha, $perfil, $situacao, $cliente_nome, $role_nome, $situacao_label, $color_st;
    public $form_show = '1';
    ...
    public function render(){
        ...
        return view('livewire.adm.l-w-adm-usuario');
    }
    ...
    public function deletar($data){
        ...
        $this->situacao_label = $situacao['label'];
        $this->color_st = $user->role->cor;
        $this->modal_title = "Cadastro de Usuários";
